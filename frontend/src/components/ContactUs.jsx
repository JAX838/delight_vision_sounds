      ...
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-800 mb-3">
            Contact <span className="text-blue-600">Delight Vision Sounds</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          {/* Contact Information */}
          <div className="bg-amber-400 text-white p-8 rounded-2xl shadow-md flex flex-col justify-center">
            ...
            <div className="mt-8">
              <div className="w-full h-56 rounded-lg overflow-hidden border-0">
                <iframe
                  title="Delight vision sounds - Luthuli Avenue"
